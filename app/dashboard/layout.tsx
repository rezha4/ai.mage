        ...
        <div className="space-y-8 w-full">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <Link href={"/dashboard/add/remove-background"}>
              ...
              >
                <TransparencyGridIcon  />
                <p hidden={!showSidebar} className=" mb-1">Remove BG</p>
              </Button>
            </Link>
            ...
            <Link href={"/dashboard/add/restore"}>
              <Button
                className={`flex justify-between w-full hover:bg-gray-600 ${
                  pathname === "/dashboard/add/restore" ? "bg-gray-600" : ""
                }`}                
              >
                <CameraIcon width={20} height={20} />
                <p hidden={!showSidebar} className=" mb-1">HD-ify</p>
              </Button>
            </Link>
            <Link href={"/dashboard/add/recolor"}>
              <Button
                className={`flex justify-between w-full hover:bg-gray-600 ${
                  pathname === "/dashboard/add/recolor" ? "bg-gray-600" : ""
                }`}                
              >
                <Half2Icon width={20} height={20} />
                <p hidden={!showSidebar} className=" mb-1">Object Recolor</p>
              </Button>
            </Link>
          </div>
        </div>
